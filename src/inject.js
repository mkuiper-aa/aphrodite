...
export const Injector = (document /* : ?Document */ = undefined) => {
    ...
    const injectStyleTag = (cssContents /* : string */) => {
        ...
        if (!document) {
            throw new Error(
                "Cannot inject a style tag without a document");
        }
    ...
    const getRenderedClassNames = () => {
        return Object.keys(alreadyInjected);
    };
    
    const addRenderedClassNames = (classNames /* : string[] */) => {
